...
void TestRemoveDocument()
{
    ...
    std::map<std::string, double> test = search_server.GetWordFrequencies(1);
...
void TestRemoveDuplicates()
{
    ...
    std::map<std::string, double>test = search_server.GetWordFrequencies(5);
    std::map<std::string, double>test1 = search_server.GetWordFrequencies(1);
